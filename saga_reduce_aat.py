...
if __name__ == '__main__':
    ...
    parser.add_argument('firstexposurenum', type=int)
    parser.add_argument('-n', '--n-science', default=4, type=int)
    parser.add_argument('-r', '--redflat-index', default=0, type=int)
    parser.add_argument('-b', '--blueflat-index', default=1, type=int)
    parser.add_argument('-a', '--arc-index', default=2, type=int)
    parser.add_argument('-o', '--sci-offset', default=3, type=int)
    parser.add_argument('--bias-start', default=1, type=int)
    parser.add_argument('--n-bias', default=10, type=int)
